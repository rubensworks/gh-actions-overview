...
import { readFilters, writeFiltersToUrl } from '../lib/urlState';
...
export function Dashboard(props: IDashboardProps) {
  const { client, viewer, settings, onSettingsChange, onSignOut } = props;

  const [ filters, setFilters ] = useState<IFilters>(() => readFilters(location.search));
  ...
  const store = useMemo(
    () => new DashboardStore(client, settings, (event) => {
